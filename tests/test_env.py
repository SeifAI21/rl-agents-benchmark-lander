...
def test_logging_schema() -> None:
    """Write a few rows with RunLogger; TensorBoard is optional in broken local envs."""
    import shutil
    ...
    if logger.tb_enabled:
        # Check a TB event file was written when TensorBoard initialized successfully.
        tb_files = [
            f
